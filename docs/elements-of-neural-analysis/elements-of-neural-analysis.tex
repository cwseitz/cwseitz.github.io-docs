...
\chapter{Gabor Theory and Image Statistics}

\section{2D Gabor Wavelets}

The 2D Gabor wavelet in the spatial domain is the product of an elliptical gaussian function with a harmonic function
