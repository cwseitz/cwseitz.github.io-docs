...
\caption{DDPM estimation of marginal variances. A low-resolution image $\bold{x}$ (left) is transformed by $\phi$ to produce a KDE estimate $\hat{\bold{y}}$ (middle) and a DDPM $\Psi$ computes a map of marginal variances (right)}
\end{figure}
