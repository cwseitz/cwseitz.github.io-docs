...
&= h_{i}^{2}h_{j}^{2}\langle a_{S}^{\dagger}a_{S}^{\dagger}a_{S}a_{S}\rangle + h_{i}^{2}\langle a_{S}^{\dagger}a_{B}^{\dagger}a_{S}a_{B}\rangle +  h_{i}h_{j}\langle a_{S}^{\dagger}a_{B}^{\dagger}a_{B}a_{S}\rangle \\
...
\begin{align*}
g^{2}_{ij}(0) &= \frac{\xi h_{i}^{2}h_{j}^{2}N_{0}^{2} + \xi N_{0}B_{0}(h_{i} + h_{j})^{2} + B_{0}^{2}}{\xi^{2} h_{i}^{2}h_{j}^{2}N_{0}^{2} + \xi N_{0}B_{0}(h_{i}^{2}+h_{j}^{2}) +  B_{0}^{2}}
\end{align*}

or if we let $\eta = N_{0}/B_{0}$

\begin{align*}
g^{2}_{ij}(0) = \frac{\xi h_{i}^{2}h_{j}^{2}\eta^{2} + \xi\eta(h_{i}+h_{j})^{2} + 1}{\xi^{2} h_{i}^{2}h_{j}^{2}\eta^{2} + \xi\eta(h_{i}^{2}+h_{j}^{2}) +  1} 
\end{align*}
