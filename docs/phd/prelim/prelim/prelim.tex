...
\begin{itemize}
\item U2OS two-color test (if JF549 looks good, take long movies)
\item Hela long movie test for 10pM, 20pM, 50pM JF646 and 1pM and 5pM JF549
\item Clustering analysis - assess point accumulation with time
\end{itemize}

\begin{itemize}
\item Performance comparison of CNN with LoG algorithm
