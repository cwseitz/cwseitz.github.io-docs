...
\item Nucleosome clustering is poorly characterized at super-enhancers
...
\item BRD4 can also phase separate in multivalent protein complexes
\end{itemize}
\end{textblock*}
...
\item Reduced localizations increases time-resolution but degrades spatial resolution
\end{itemize}
\end{textblock*}
\begin{textblock*}{13cm}(1cm,3.0cm)
...
\begin{itemize}
\item Maintaining constant resolution with increasing uncertainty requires increasing density
\item However, localization uncertainty is not independent of labeling density
\end{itemize}
...
\begin{textblock*}{3cm}(10.0cm,6cm)
