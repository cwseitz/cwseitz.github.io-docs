...
\section{Single molecule localization microscopy (SMLM)}
...
Assume $\mu_{k}$ is constant over $\textcolor{blue}{\Delta}$ (homogeneous Poisson)
...
\section{Probing chromatin structure with SMLM}
