...
\item Cramer-Rao lower bound (CRLB) in 2D can be computed analytically for Poisson log-likelihood $\ell$ (Smith 2010, Huang 2013)
\end{itemize} 
 
\end{frame}

\begin{frame}{Localization precision sets the resolution limit in localization microscopy}
