...
\begin{frame}{TO DO}
\begin{itemize}
\item Figure 1b: $k_{1},k_{2}$ inference
\item Figure 1c,d: Performance comparison of CNN with LoG algorithm
...
\end{figure}
Point spread functions of ~10nm Quantum Dots at 655nm for high NA (1.25) and low NA (0.8) 60X oil immersion objective
\end{frame}
