...
\textbf{Part 1}
\begin{itemize}
\item Imaging strategy and BASIC processing
\item Image stitching, registration, segmentation with MCMICRO
\end{itemize}
\textbf{Part 2}
\begin{itemize}
...
\begin{frame}{The MCMICRO pipeline}
\begin{figure}
\includegraphics[width=14cm]{mcmicro.png}
\end{figure}
\end{frame}
...
\begin{frame}{Stitching a single channel with ASHLAR}
\begin{figure}
\includegraphics[width=12cm]{tiling-2.png}
\end{figure}
\textit{Courtesy of the Laboratory of Systems Pharmacology at Harvard}
\end{frame}

\begin{frame}{Registering images between cycles with ASHLAR}
\begin{figure}
