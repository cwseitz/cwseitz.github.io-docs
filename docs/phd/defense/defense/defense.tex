...
\section{Enhanced nanoscopy with single photon avalanche diode (SPAD) cameras}

%\begin{frame}{Hanbury-Brown and Twiss interferometry}
%\begin{textblock*}{12cm}(1.5cm,2.0cm)
%\includegraphics[width=12cm]{../../spad/spad/media/HBT.png}
%\end{textblock*}
...
\begin{frame}{Conventional CMOS cameras are noisy}
...
\begin{frame}{Widefield photon counting}
...
\begin{textblock*}{12cm}(1.5cm,2.0cm)
\includegraphics[width=12cm]{../../spad/spad/media/Figure-0-Crop-1.png}
\end{textblock*}
\end{frame}
...
%\begin{textblock*}{10cm}(1.5cm,7.0cm)
%Define $\zeta = \langle n\rangle$ where $x$ is the number of photons counts per frame
%\begin{equation*}
%p(N,\zeta\lvert n) \propto p(n\lvert N,\zeta)p(\zeta)\rightarrow p(N\lvert n) = \int p(N,\zeta\lvert n) %d\zeta
%\end{equation*}
%\end{textblock*}

\end{frame}

\begin{frame}{Quantum illumination with spontaneous parametric downconversion}
\begin{textblock*}{5cm}(1.5cm,1.3cm)
\includegraphics[width=5cm]{../../spad/spad/media/SPDC-Setup.png}
\end{textblock*}
\begin{textblock*}{6cm}(7.5cm,2.0cm)
\includegraphics[width=6cm]{../../spad/spad/media/SPDC.png}
\end{textblock*}
\begin{textblock*}{6cm}(8cm,5.5cm)
\includegraphics[width=3cm]{../../spad/spad/media/SPDC-2.png}
\end{textblock*}
\end{frame}
...
\includegraphics[width=12cm]{../../brd4/brd4/media/Rouse}
\end{frame}
