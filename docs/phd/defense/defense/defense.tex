...
\animategraphics[width=3cm,autoplay,loop]{60}{media/spad-snip1/spad-snip1-}{1}{100}
\end{textblock*}
\begin{textblock*}{3cm}(0.5cm,5.0cm)
\animategraphics[width=3cm,autoplay,loop]{60}{media/spad-snip2/spad-snip2-}{1}{100}
\end{textblock*}
...
\animategraphics[width=13cm,autoplay,loop]{30}{media/langevin/langevin-}{1}{152}
\end{textblock*}
...
\begin{frame}{Coarse grained molecular dynamics of chromatin binders}
