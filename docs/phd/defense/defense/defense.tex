...
\begin{frame}{Integrated approach for super resolution microscopy}
\begin{textblock*}{7cm}(0.5cm,1.5cm)
\includegraphics[width=7cm]{../../spad/spad/media/Setup.png}
\end{textblock*}
\end{frame}
...
\includegraphics[width=14cm]{../../dissertation/dissertation/media/Lab.png}
\end{textblock*}
