...
\begin{frame}{Localization using a deep generative model}

Define particle coordinates as a latent variable $\bm{z}$. Variational autoencoders use neural networks to represent $P_{\Theta}(z|h)$ and $P_{\Phi}(h|z)$.
