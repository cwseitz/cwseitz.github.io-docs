...
&= \frac{1}{Z_{ij}}\left(\sum_{x,y} \frac{1}{\sigma_{i}\sqrt{2\pi}}\exp\left(-\frac{1}{2}\frac{|\mathbf{r}-\mathbf{r}_{0}|^{2}}{\sigma_{i}^{2}} \right) - \frac{1}{2\pi\sigma_{i}^{2}}\exp\left(-\frac{|\mathbf{r}-\mathbf{r}_{0}|^{2}}{\sigma_{i}^{2}} \right)\right)\\
\end{align*}
