...
\setbeamertemplate{footline}[text line]{%
  \parbox{\linewidth}{\vspace*{-8pt}Deep generative models for spatial transcriptomics\hfill\insertshortauthor\hfill\insertpagenumber}}
...
\title{Deep generative models for spatial transcriptomics}	% Presentation title
