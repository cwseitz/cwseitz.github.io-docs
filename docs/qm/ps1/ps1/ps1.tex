...
Let $a$ and $b$ represent the components of the eigenket $\ket{+}$ of this operator. We then need to solve the following system for the components $a$ and $b$

\begin{align*}
a(\cos\beta-e) + b(\sin\beta\exp(-i\alpha)-e) &= 0\\
a(\sin\beta\exp(i\alpha)-e) + b(-\cos\beta-e) &= 0
\end{align*}

where $e$ represents the eigenvalue.
