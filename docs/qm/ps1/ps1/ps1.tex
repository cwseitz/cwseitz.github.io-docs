...
My intuition says that we are rotating the spin about the axis of rotation $\hat{n}$ by an angle $\phi$, but I'm unsure how to prove this from the above expression.
