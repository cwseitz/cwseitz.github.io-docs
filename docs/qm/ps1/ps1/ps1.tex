...
Presumably this means that we can form a new set of operators $\bm{\sigma}$ in an arbitrary basis which have the same properties as the Pauli matrices. Choosing $\bm{\hat{n}} = \hat{z}$ just gives us the Pauli matrices again, as it should.
