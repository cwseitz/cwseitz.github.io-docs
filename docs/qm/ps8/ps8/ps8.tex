...
where $\beta = 4\Delta/\hbar^{2}$. We would like to use Schrodinger's equation to write out the time evolution; however, it isn't immediately clearly what the eigenkets of $H$ are. Recall,
