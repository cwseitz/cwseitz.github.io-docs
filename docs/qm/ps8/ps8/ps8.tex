...
&= -\frac{i\lambda}{\hbar}\left(\frac{e^{i(\omega_{0}+\omega)t}-1}{\omega_{0}+\omega}+\frac{e^{i(\omega_{0}-\omega)t}-1}{\omega_{0}-\omega}\right)
\end{align*}

The probability the system is found in the state $\ket{1}$ is

\begin{align*}
|c_{1}(t)|^{2} = -\frac{\lambda}{\hbar}
\end{align*}
