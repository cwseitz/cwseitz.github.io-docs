...
&= \frac{1}{2}\left(\frac{\hbar}{2m\omega}\right)^{\frac{n}{2}}\left(\bra{0}+ \bra{1}\right)\left(a+a^{\dagger}\right)^{n}\left(\ket{0}+ \ket{1}\right)\\
&= \frac{1}{2}\left(\frac{\hbar}{2m\omega}\right)^{\frac{n}{2}}\left(\bra{0}+ \bra{1}\right)\\
&\left( \sum_{k=0}^{n}{n\choose k}\left(\frac{(n-k)!}{\sqrt{(n-2k)!}}\ket{n-2k}+\frac{(n-k+1)!}{\sqrt{(n-2k+1)!}}\ket{n-2k+1}\right)\right)\\
&= \frac{1}{2}\left(\frac{\hbar}{2m\omega}\right)^{\frac{n}{2}}
\end{align*}

\begin{align*}
[p^{n}] &= \bra{\alpha_{+}}p^{n}\ket{\alpha_{+}}\\
&= \frac{1}{2}\left(\bra{0}+ \bra{1}\right)p^{n}\left(\ket{0}+ \ket{1}\right)\\
&= (-i)^{n}\frac{1}{2}\left(\frac{m\hbar\omega}{2}\right)^{\frac{n}{2}}\left(\bra{0}+ \bra{1}\right)\left(a-a^{\dagger}\right)^{n}\left(\ket{0}+ \ket{1}\right)\\
&= (-i)^{n}\frac{1}{2}\left(\frac{m\hbar\omega}{2}\right)^{\frac{n}{2}}\left(\bra{0}+ \bra{1}\right)\left(\ket{1}-\ket{0}\right)\\
&= 0
\end{align*}
