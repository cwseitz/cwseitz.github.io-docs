...
I have a broad background in machine learning, statistics, and physics/mathematics. I specialize in digital signal processing, optimization problems, and machine learning methods for time series analysis and generative modeling. I have long term experience with the Python data science stack.
...
\item Designed general computer vision algorithms for object detection/tracking, segmentation, etc. in PyTorch 

\item Designed diffusion models/score-based generative models, GANs, for modeling image datasets in super-resolution microscopy
...
\item Deployed tracking algorithms for microscopy automation with real-time feedback
