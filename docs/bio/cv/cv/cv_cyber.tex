...
\item Designed diffusion models/score-based generative models, GANs, and general computer vision techniques (object detection, segmentation, etc.) in PyTorch for modeling image datasets in super-resolution microscopy
