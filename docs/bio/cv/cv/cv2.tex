...
I have a broad background in machine learning, physics, and mathematics. Recently, I have researched variational diffusion models for image generation. I also specialize in geometric deep learning and diffusion models on graph-structured data. 
