...
My research primarily consists of the application high-dimensional stochastic methods, information theory, and Bayesian statistical inference to problems related to digital image processing and unsupervised learning of gene interaction networks. This sometimes involves algorithm development at the level of model inference from data which can require optimization of deep networks and/or graphical models. I am primarily familiar with optimization algorithms inspired by physics e.g., Langevin dynamics, MCMC, and simulated annealing. I am also interested in the implementation of statistical inference in the dynamics of recurrent networks of integrate and fire neurons. This is a Bayesian interpretation of neural dynamics and neural sampling, inspired by the Boltzmann machine.

In my personal life, I like to write music and digital signal processing software for audio effects. Also, I like to tinker with vintage vacuum tube amplifiers and occasionally do some woodworking.
