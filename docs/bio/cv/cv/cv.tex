...
Broadly interested in complex nonlinear systems and stochastic dynamics. My current work involves modeling of gene regulatory networks in biology. This involves a broad range of tools derived from machine learning, information theory, control theory, and Bayesian statistics. Generally I focus on algorithm development for model inference from empirical data and simulations, aiming to make predictions.
