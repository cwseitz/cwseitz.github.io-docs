...
I combine deep learning with Bayesian statistics to achieve precise 3D localization microscopy \emph{in vitro}. In particular, I have combined deep image models for image restoration with stochastic gradient langevin dynamics to achieve reconstructions of nuclear protein complexes with sub 10-nanometer resolution. This involves a broad array of theoretical tools from statistical physics, information theory, and optics. Currently I am applying these models to study nucleosome organization and phase transitions of DNA-protein condensates during the immune response.
