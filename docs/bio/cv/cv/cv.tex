...
Physical/Mathematical: Theory and applications of deep learning for computer vision tasks in fluorescence microscopy, single molecule localization microscopy, Monte Carlo methods, information theory, information geometry.

Biological: The relationship between 3D DNA structure and transcriptional states. High-throughput microscopies built around \emph{in-situ} hybridization based methods 
