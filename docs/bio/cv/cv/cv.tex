...
My research focuses on reconstruction of super-resolution fluorescence microscopy images from single molecule localization microscopy (SMLM) time series. I design generative image models based on Markovian photoswitching of fluorescent molecules complemented by inference methods for super-resolution reconstruction. This involves a broad array of theoretical tools from physics, information theory, information geometry, and Bayesian statistics. Currently I am applying these models to study nucleosome organization and phase transitions of DNA-protein condensates during the immune response.
