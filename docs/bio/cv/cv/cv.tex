...
I maintain a diverse background and specialize in the development and application of machine learning models. Recently, I have developed deep generative models as well as analytical probabilistic methods for modeling imaging datasets. These models have been applied to fluorescence microscopy to fuel biological discovery.
...
\item Performed Monte Carlo simulations of spiking neural networks to relate neural network architecture to spiking dynamics
...
\item Developed an package in Python for high-throughput image processing
