...
My research focuses on studying DNA-protein condensates formed during the immune response using single molecule localization microscopy. To reconstruct super-resolution fluorescence images of these condensates, I design deep generative image models, using a broad array of theoretical tools from physics, information theory, information geometry, and Bayesian statistics. Additionally, I model the phase transitions of DNA-protein condensates using Langevin dynamics and Monte Carlo simulations.
