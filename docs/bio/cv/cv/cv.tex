...
I maintain a diverse background and specialize in machine learning models and super-resolution microscopy. Recently, I have developed deep generative models as well as analytical probabilistic methods for modeling imaging datasets. These models have been applied to fluorescence microscopy to fuel biological discovery.
