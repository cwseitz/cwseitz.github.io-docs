...
My research focuses on reconstruction of 3D super-resolution fluorescence microscopy images from recordings of Markovian photoswitching of fluorescent molecules \emph{in vitro}. In particular, I have combined deep image models for image restoration with Bayesian localization methods based on stochastic gradient langevin dynamics to achieve reconstructions of nuclear protein complexes with sub 10-nanometer resolution. This involves a broad array of theoretical tools from statistical physics, information theory, information geometry, and Bayesian statistics. Currently I am applying these models to study nucleosome organization and phase transitions of DNA-protein condensates during the immune response.
