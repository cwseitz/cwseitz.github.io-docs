...
I have experience in the design, development, and application of algorithms for processing raw sensor data and efficient 2D/3D tracking. In addition, I have extensive experience with Python/C/C++, Tensorflow, and real-time sensor data
...
\item Developed hardware and software systems for precise 2D/3D particle tracking applications in statistical physics
\item Modeled stochastic behaviors of physical systems and sensors for precision measurements
\item Used physical principles and signal processing concepts for algorithm/model development
\item Applied machine learning models for computer vision and general data analysis
\item Developed optimization algorithms for localization of objects in microscopy datasets
