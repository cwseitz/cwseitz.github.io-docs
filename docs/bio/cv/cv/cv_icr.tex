...
I have a background in physics, statistics, and machine learning. Recently, I have researched variational inference with diffusion models. I also specialize in Bayesian modeling and the application of machine learning methods for time series analysis and generative modeling.
...
%I have a background in physics, machine learning, and mathematics. Recently, I have researched novel image/video generation methods based on diffusion models. I also specialize in image/video processing, object detection, segmentation, and object tracking. These methods were applied in biological research.
...
\item Designed diffusion models/score-based generative models in PyTorch for modeling image datasets in super-resolution microscopy

\item Developed analysis pipelines for high-throughput analysis of spatial point processes 
