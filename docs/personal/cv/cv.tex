...
To develop a mathematical description of memory formation and retrieval in complex networks; in particular, networks of neurons. I am also interested in the storage limits of such systems, their ability to compress incoming signals, and optimization problems that can be solved by dynamical processes on these networks.
