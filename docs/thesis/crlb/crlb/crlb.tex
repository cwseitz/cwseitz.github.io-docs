...
\subfigure[Theoretical prediction of $P(S_{k},H_{k})$ and marginal distributions]{\label{fig:a}\includegraphics[width=120mm]{theoretical}}
\subfigure[Sampling of $P(S_{k},H_{k})$ and marginal distributions]{\label{fig:b}\includegraphics[width=120mm]{experimental}}
