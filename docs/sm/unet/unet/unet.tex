...
\title{Semantic Segmentation of WM989 Cells with U-NET}	% Presentation title
...
\begin{center}
\begin{figure}
\includegraphics[width=0.85\textwidth]{scvi.png}
...
Single-cell RNA expression has sample, batch, and real biological variability. Need a lot of data

\textbf{Motivation}: Automating segmentation, simple thresholding/watershed do not work well over large FOV and make imprecise estimates of cell boundaries\\
\vspace{0.1in}
...
\begin{frame}{Boundary-only model}
