...
\begin{figure}
\includegraphics[width=3cm]{ch1.jpg}
\end{figure}
\end{textblock*}
\begin{textblock*}{3cm}(6.5cm,1cm)
\begin{figure}
\includegraphics[width=3cm]{ch2.jpg}
\end{figure}
\end{textblock*}
\begin{textblock*}{3cm}(9.5cm,1cm)
\begin{figure}
\includegraphics[width=3cm]{ch3.jpg}
\end{figure}
\end{textblock*}
\begin{textblock*}{3cm}(3.5cm,4cm)
\begin{figure}
\includegraphics[width=3cm]{ch4.jpg}
\end{figure}
\end{textblock*}
\begin{textblock*}{3cm}(6.5cm,4cm)
\begin{figure}
\includegraphics[width=3cm]{ch5.jpg}
\end{figure}
\end{textblock*}
\begin{textblock*}{3cm}(9.5cm,4cm)
\begin{figure}
\includegraphics[width=3cm]{ch6.jpg}
\end{figure}
\end{textblock*}
